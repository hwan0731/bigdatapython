...
# 멜론 차트 페이지 URL
url = 'https://www.oliveyoung.co.kr/store/main/getBestList.do?t_page=%ED%99%88&t_click=GNB&t_gnb_type=%EB%9E%AD%ED%82%B9&t_swiping_type=N'  # 멜론의 최신 차트 URL로 확인 필요
